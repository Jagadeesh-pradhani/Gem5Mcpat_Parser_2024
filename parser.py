"""
[usage]:
python3 parser.py --config m5out/config.json --stats m5out/old.txt --template mcpat-in1.xml
...
def prepareTemplate(outputFile):
    ...
    # Point to L2
    sharedL2 = 'l2_cntrl0' in config["system"]["ruby"].keys()
    ...
    prettify(root)
    templateMcpat.write(outputFile.name)
